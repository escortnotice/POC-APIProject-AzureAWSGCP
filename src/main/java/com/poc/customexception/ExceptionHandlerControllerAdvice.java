...
public class ExceptionHandlerControllerAdvice extends ResponseEntityExceptionHandler{
	...
	@ResponseBody
	public ResponseEntity<Object> databaseUnavailableException(JDBCConnectionException exception) {
		APIResponse apiResponse = BuildResponseUtil.buildErrorResponseObject(exception.getMessage(),
				CustomErrorCodeAndMessages.DATABASE_UNAVAILABLE);
